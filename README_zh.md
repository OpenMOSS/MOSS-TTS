...
<a id="news"></a>
## 新闻
* 2026.3.4：🎉 MOSS-TTS 现已支持 [🦞 龙虾](https://clawhub.ai) API skills：[feishu-voice-tts](https://clawhub.ai/k979jzrdhbm4r6dk4setx2bykn827qsj) 与 [moss-tts-voice](https://clawhub.ai/luogao2333/moss-tts-voice)。
...
MOSS-TTS 现已支持 [OpenClaw](https://clawhub.ai) 的以下 API skills。API Key 可在 [MOSI AI Studio](https://studio.mosi.cn) 获取。

| Skill | 说明 | 安装命令 |
|---|---|---|
| `feishu-voice-tts` | 在飞书发送语音消息 | `clawhub install feishu-voice-tts` |
